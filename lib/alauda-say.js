...
const alaudaSay = (words)=>{
	...
	template += `      ${chalk.yellow("│ @@@@@@@@@@@@@@@@@@@@@@@@ │")}               \n`;
	template += `      ${chalk.yellow("│ ######################## │")}    ${chalk.hex("#34AFE4")(" /ˉˉˉˉˉˉ\\")}  \n`;
	template += `      ${chalk.yellow("╰──────────────────────────╯")}    ${chalk.hex("#34AFE4")("/        \\")} \n`;
	template += `                                   ${chalk.yellow("\\")} ${chalk.hex("#34AFE4")("<  ●       |")}\n`;
	template += `                                      ${chalk.hex("#34AFE4")("|         |")}\n`;
	template += `                                      ${chalk.hex("#34AFE4")(" |        |")}\n`;
	template += `                                      ${chalk.hex("#34AFE4")("  \\       |")}\n`;
	template += `                                      ${chalk.hex("#34AFE4")("   ˉˉ\\    |")}\n`;
	template += `                                      ${chalk.hex("#34AFE4")("      ˉˉˉ\\|")}\n`;
